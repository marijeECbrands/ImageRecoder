...
APP_NAME = "Fashion Image Renamer v6.5"
CACHE_VERSION = "6.5"
...
def run_pipeline(
    ...
    cache_path = output_dir / "classification_cache_v6_5.json"
    cache: dict[str, dict] = {}
    ...
    with tempfile.TemporaryDirectory(prefix="fashion_v63_") as temp_name:
        ...
        for group_entries in grouped_pending.values():
            ...
            for entry in group_entries:
                ...
                if category not in categories:
                    safe_copy(r, image, review_dir, image.name)
                    results.append(r)
                    continue
        ...
        for entry in ungrouped_pending:
            r = entry["result"]
            safe_copy(r, entry["image"], review_dir, entry["image"].name)
            results.append(r)
